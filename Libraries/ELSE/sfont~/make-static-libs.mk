...
config_options = --prefix=$(build_dir) --disable-option-checking --disable-shared --disable-dependency-tracking --enable-option-checking CC="gcc" CXX="g++" CPP="gcc -E"  CXXCPP="g++ -E"
