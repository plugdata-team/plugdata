...
struct AboutPanel : public Component {
    ...
    void paint(Graphics& g) override
    {
        ...
        g.drawFittedText("ELSE v1.0-rc5 by Alexandre Porres", 150, 110, getWidth() - 150, 30, Justification::left, 1);
        ...
        g.drawFittedText("Special thanks to: Deskew Technologies, ludnny, kreth608, Joshua A.C. Newman, chee, polarity, Soundworlds-JO, grabanton, daniellumertz, vasilymilovidov and emptyvesselnz for supporting this project", 150, 270, getWidth() - 200, 80, Justification::left, 3);
