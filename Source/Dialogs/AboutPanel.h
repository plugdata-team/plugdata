...
public:
    void paint(Graphics& g) override
    {
        ...
        g.drawFittedText("Special thanks to: Deskew Technologies, ludnny, kreth608, Joshua A.C. Newman, chee, polarity, Soundworlds-JO, grabanton, vasilymilovidov, Omar-Misa for supporting this project", 150, 270, getWidth() - 200, 80, Justification::left, 3);
