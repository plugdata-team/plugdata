            ...
            { "General",
                {
                    ...
                    { Icons::GlyphGeneric, "#X obj 0 0 trigger", "Trigger", "Trigger", OtherObject },
                    { Icons::GlyphGeneric, "#X obj 0 0 moses", "Moses", "Moses", OtherObject },
                    { Icons::GlyphGeneric, "#X obj 0 0 spigot", "Spigot", "Spigot", OtherObject },
                    { Icons::GlyphGeneric, "#X obj 0 0 bondo", "Bondo", "Bondo", OtherObject },
