        ...
        { "General",
            {
                ...
                { Icons::GlyphCounter, "#X obj 0 0 count 5", "Count", "Count" },
                { Icons::GlyphGeneric, "#X obj 0 0 trigger", "Trigger", "Trigger" },
                { Icons::GlyphGeneric, "#X obj 0 0 moses", "Moses", "Moses" },
                { Icons::GlyphGeneric, "#X obj 0 0 spigot", "Spigot", "Spigot" },
                { Icons::GlyphGeneric, "#X obj 0 0 bondo", "Bondo", "Bondo" },
        ...
        { "IO",
            {
                ...
                { Icons::GlyphGeneric, "#X obj 0 0 s", "Send", "Send" },
                { Icons::GlyphGeneric, "#X obj 0 0 r", "Receive", "Receive" },
                { Icons::GlyphGeneric, "#X obj 0 0 s~", "Send~", "Send~" },
                { Icons::GlyphGeneric, "#X obj 0 0 r~", "Receive~", "Receive~" },
            } },
        { "Osc~",
