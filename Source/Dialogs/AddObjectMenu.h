            ...
            { "FX~",
                {
                    ...
                    { Icons::GlyphGenericSignal, "#X obj 0 0 svfilter~ 1729 0.42", "State variable filter", "SVFilter", OtherObject },
                    { Icons::GlyphGenericSignal, "#X obj 0 0 clip~ -0.5 0.5", "Clip", "Clip", OtherObject },
                    { Icons::GlyphGenericSignal, "#X obj 0 0 fold~ -0.5 0.5", "Fold", "Fold", OtherObject },
                    { Icons::GlyphGenericSignal, "#X obj 0 0 wrap2~ -0.5 0.5", "Wrap", "Wrap", OtherObject },
                }},
            { "Math",
                {
