...
struct Dialogs {
    ...
    static void showOkayCancelDialog(std::unique_ptr<Dialog>* target, Component* parent, String const& title, std::function<void(bool)> const& callback, StringArray options = {
        "Okay", "Cancel "}, bool swapButtons = false);
