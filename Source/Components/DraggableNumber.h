...
struct DraggableListNumber : public DraggableNumber {
    ...
    void render(NVGcontext* nvg) override
    {
        ...
        if (hoveredDecimal >= 0) {
            ...
            nvgFillColor(nvg, NVGComponent::convertColour(highlightColour));
            nvgFillRoundedRect(nvg, hoveredDecimalPosition.getX(), hoveredDecimalPosition.getY() - 2, hoveredDecimalPosition.getWidth(), hoveredDecimalPosition.getHeight(), 2.5f);
        }
