...
public:
    ...
    */
    void startDragging(var const& sourceDescription,
        ...
        ScaledImage const& dragErrorImage = ScaledImage(),
    ...
    */
    ...
    /** Utility to find the ZoomableDragAndDropContainer for a given Component.
        ...
        parent component which is a ZoomableDragAndDropContainer.

        It's useful when a component wants to call startDragging but doesn't know
        the ZoomableDragAndDropContainer it should to use.
