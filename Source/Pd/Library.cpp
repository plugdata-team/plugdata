...
{
    auto const& pathTree = SettingsFile::getInstance()->getProperty<VarArray>("paths");
...
{
    for (auto path : SettingsFile::getInstance()->getProperty<VarArray>("paths")) {
