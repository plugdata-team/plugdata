...
class Patch
{
   ...
   private:
    ...
    static inline const std::map<String, String> guiDefaults = {{"tgl", "23 0 empty empty empty 17 7 0 10 bgColour fgColour lblColour 0 1"},
                                                                ...
                                                                {"nbx", "4 19 -1e+37 1e+37 0 0 empty empty empty 0 -8 0 10 bgColour lblColour lblColour 0 256"},
                                                                {"hradio", "18 1 0 8 empty empty empty 0 -8 0 10 bgColour lnColour lblColour 0"},
                                                                {"vradio", "18 1 0 8 empty empty empty 0 -8 0 10 bgColour lnColour lblColour 0"},
